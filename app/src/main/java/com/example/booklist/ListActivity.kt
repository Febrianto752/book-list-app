...
import com.example.booklist.databinding.ActivityListBinding

class ListActivity : ComponentActivity(), BookClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.recyclerView.apply {
            ...
            adapter = CardAdapter(bookList, listActivity)
        }

        val logoutButton = findViewById<ImageButton>(R.id.imageButtonLogout)
